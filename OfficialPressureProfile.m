...
T_surf=265; %Surface Temp of planet (in K)
Base_Flux=200/1000;  %Heat Flux (in W/m^2)
...
resolution=.01;   %height of each step in km (can be decimals)
...
elseif (h>=13.804) && (h<21.0166);
    ...
    P1=Patmosphere +((rho1*g*h1) + (rho2*g*h))*1000; %pressure of glacier between Ice II and Ice V boundary
...
% vectors
T_Start=200*ones(1,length(Height_list));      %Starting Temp.
