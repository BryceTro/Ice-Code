...
%'/Users/luju/Dropbox/Mac/Documents/LHS1140B'
...
Pressure_Profile = cat(1,Height_list',T_Start',Pressure',rho',alpha',Cp',K',phase',MeltT');
  
Pressure_Profile_Final = array2table(Pressure_Profile,'RowNames',{'Height(km)','Temperature(K)','Pressure(MPa)',...
    'Density(kg/m^3)','Thermal Expansivity(K^-1)','Specific Heat(J/kg/K)','Thermal Conductivity(W/m/K)','Phase','Melting Temperature(K)'})
